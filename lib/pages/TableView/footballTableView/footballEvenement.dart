...
class FootballEvenementPage extends StatefulWidget {
  @override
  _FootballEvenementPageState createState() => _FootballEvenementPageState();
}

class _FootballEvenementPageState extends State<FootballEvenementPage> {
      ...
      child: Scaffold(
        body: StreamBuilder<List<EventData>>(
          ...
          builder: (context, snapshot) {
            ...
            final eventsDatas = events.where((e) => e.typeJeu == TypeJeu.EVENEMENT.name&&e.sousCategorie == 'Football').toList();

            return CustomScrollView(
              slivers: [
                SliverAppBar(
                  title: Text('Football Événements',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w900),),
