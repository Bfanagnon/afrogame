...
class FootballGameStoryPage extends StatefulWidget {
  @override
  _FootballGameStoryPageState createState() => _FootballGameStoryPageState();
}

class _FootballGameStoryPageState extends State<FootballGameStoryPage> {
      ...
      child: Scaffold(
        body: StreamBuilder<List<EventData>>(
          ...
          builder: (context, snapshot) {
            ...
            final gbovianEvents = events.where((e) => e.typeJeu == TypeJeu.GAMESTORY.name&&e.sousCategorie == 'Football').toList();

            return CustomScrollView(
              slivers: [
                SliverAppBar(
                  title: Text('Football Game Story',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w900),),
                  floating: true,
                ),
                SliverList(
